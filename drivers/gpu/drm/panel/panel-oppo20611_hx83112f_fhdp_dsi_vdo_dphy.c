...
static void tm_panel_init(struct tianma *ctx)
{
	...
	tm_dcs_write_seq_static(ctx, 0xE4, 0x33,0x4C,0x66,0x80,0x99,0xC2,0xD0,0xDD,0xEB,0xFF,0xFF,0x03,0x70,0x87,0x9E,0xB5,0xCC,0xF5,0x25,0x54,0x85,0xAA,0xFA,0x03,0xC2,0xF5,0x28,0x5C,0x8F,0xC5,0xF4,0x23,0x51,0xA5,0xEA,0x03);
		...
		void *handle, unsigned int cabc_mode)
{
	...
	/*if(cabc_mode == 2)
		return;
	*/
	if (cabc_mode == 1 || cabc_mode == 3 || cabc_mode == 0 || cabc_mode == 2) {
		bl_tb1[1] = cabc_mode;
...
static struct mipi_dsi_driver jdi_driver = {
	...
	.remove = jdi_remove,
	.driver = {
			.name = "oppo20611_hx83112f_fhdp_dsi_vdo_dphy_tianma_lcm_drv",
			.owner = THIS_MODULE,
