...
//add for cabc
	...
	tianma_dcs_write_seq_static(ctx, 0x81, 0x14);
	tianma_dcs_write_seq_static(ctx, 0x82, 0x15);
	tianma_dcs_write_seq_static(ctx, 0x83, 0x20);   //12bit
	tianma_dcs_write_seq_static(ctx, 0x84, 0x00);
	tianma_dcs_write_seq_static(ctx, 0xFF, 0x78,0x07,0x03);
	tianma_dcs_write_seq_static(ctx, 0x88, 0xCC);
	tianma_dcs_write_seq_static(ctx, 0x89, 0xE5);
	tianma_dcs_write_seq_static(ctx, 0x8A, 0xEd);
	tianma_dcs_write_seq_static(ctx, 0x8B, 0xEF);
	tianma_dcs_write_seq_static(ctx, 0xB3, 0xE5);
	tianma_dcs_write_seq_static(ctx, 0xAC, 0xFA);
	tianma_dcs_write_seq_static(ctx, 0xAD, 0xee);
	tianma_dcs_write_seq_static(ctx, 0x8C, 0xa9);
	tianma_dcs_write_seq_static(ctx, 0x8D, 0xb7);
	tianma_dcs_write_seq_static(ctx, 0x8E, 0xbd);
	tianma_dcs_write_seq_static(ctx, 0x8F, 0xbf);
	tianma_dcs_write_seq_static(ctx, 0x90, 0xC2);
	tianma_dcs_write_seq_static(ctx, 0x91, 0xc8);
	tianma_dcs_write_seq_static(ctx, 0x92, 0xcb);
	tianma_dcs_write_seq_static(ctx, 0x93, 0xd2);
	tianma_dcs_write_seq_static(ctx, 0x94, 0xd6);
	tianma_dcs_write_seq_static(ctx, 0x95, 0xe7);
	tianma_dcs_write_seq_static(ctx, 0xB4, 0xc7);
	tianma_dcs_write_seq_static(ctx, 0xAE, 0xD3);
	tianma_dcs_write_seq_static(ctx, 0x96, 0x70);
	tianma_dcs_write_seq_static(ctx, 0x97, 0x89);
	tianma_dcs_write_seq_static(ctx, 0x98, 0x99);
	tianma_dcs_write_seq_static(ctx, 0x99, 0x9F);
	tianma_dcs_write_seq_static(ctx, 0x9A, 0xa3);
	tianma_dcs_write_seq_static(ctx, 0x9B, 0xa6);
	tianma_dcs_write_seq_static(ctx, 0x9C, 0xa9);
	tianma_dcs_write_seq_static(ctx, 0x9D, 0xad);
	tianma_dcs_write_seq_static(ctx, 0x9E, 0xC2);
	tianma_dcs_write_seq_static(ctx, 0x9F, 0xDC);
	tianma_dcs_write_seq_static(ctx, 0xB5, 0xBA);
	tianma_dcs_write_seq_static(ctx, 0xA0, 0xC0);
	tianma_dcs_write_seq_static(ctx, 0xA1, 0x7E);
	tianma_dcs_write_seq_static(ctx, 0xA2, 0x7E);
	tianma_dcs_write_seq_static(ctx, 0xA7, 0xE5);
	tianma_dcs_write_seq_static(ctx, 0xA8, 0xE5);
	tianma_dcs_write_seq_static(ctx, 0xB6, 0x00);
	tianma_dcs_write_seq_static(ctx, 0xB7, 0xD0);
	tianma_dcs_write_seq_static(ctx, 0xB8, 0xD0);
	tianma_dcs_write_seq_static(ctx, 0xB1, 0x66);
	tianma_dcs_write_seq_static(ctx, 0xB2, 0x66);
	tianma_dcs_write_seq_static(ctx, 0x86, 0x6C);
	tianma_dcs_write_seq_static(ctx, 0x87, 0x6C);
