...
#include "p73_nq330.h"
#include "../nq330-i2c/nq330.h"
//shengtao.xiao@CN.NFC.Basic.Hardware, 2019/10/30,
#include "../oplus_nfc/oplus_nfc.h"
//#endif

extern long  pn544_dev_ioctl_nq330(struct file *filp, unsigned int cmd,
        unsigned long arg);
...
#define P61_DBG_MSG(msg...)  \
        ...
        break;                 \
        case P61_FULL_DEBUG:     \
        printk(KERN_INFO "[NXP-P61_NQ330] :  " msg); \
        break; \
        default:                 \
        printk(KERN_ERR "[NXP-P61_NQ330] :  Wrong debug level %d", debug_level); \
        break; \
        } \

#define P61_ERR_MSG(msg...) printk(KERN_ERR "[NFC-P61_NQ330] : " msg );
...
static const unsigned char SOF = 0xA5u;
        ...
        unsigned long arg)
{
    ...
    case P61_GET_ESE_ACCESS:
        ...
        ret = pn544_dev_ioctl_nq330(filp, P544_GET_ESE_ACCESS, arg);
    ...
    case P61_SET_POWER_SCHEME:
        ...
        ret = pn544_dev_ioctl_nq330(filp, P544_SET_POWER_SCHEME, arg);
    ...
    case P61_INHIBIT_PWR_CNTRL:
        ...
        ret = pn544_dev_ioctl_nq330(filp, P544_SECURE_TIMER_SESSION, arg);
