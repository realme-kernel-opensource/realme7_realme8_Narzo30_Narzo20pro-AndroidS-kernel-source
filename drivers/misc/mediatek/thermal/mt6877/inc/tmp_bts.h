...
#if defined(CONFIG_MTK_FLED_NTC_MOSS)
#define AUX_IN4_NTC (4)

#define FLASHLIGHT_RAP_ADC_CHANNEL			AUX_IN4_NTC
#define FLASHLIGHT_RAP_NTC_TABLE			7
...
#elif defined(OPLUS_FEATURE_CAMERA_COMMON)
/*Henry.Chang@Cam.Drv add for flashlight ntc 20200907*/
