 ...
 *
 ****************************************************************************/
#ifndef _IMX471MIPI_SENSOR_H
#define _IMX471MIPI_SENSOR_H
...
struct imgsensor_info_struct {
	...
	struct imgsensor_mode_struct custom2;      //custom1 scenario relative information
	struct imgsensor_mode_struct custom3;      //custom1 scenario relative information
	...
	struct imgsensor_mode_struct custom6;      //custom5 scenario relative information
