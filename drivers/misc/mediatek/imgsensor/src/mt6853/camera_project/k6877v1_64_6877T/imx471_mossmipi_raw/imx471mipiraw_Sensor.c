...
static struct imgsensor_info_struct imgsensor_info = {
    ...
    .sensor_id = IMX471_SENSOR_ID_MOSS,
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = return_sensor_id();
			...
			if (*sensor_id == IMX471_SENSOR_ID_MOSS) {
...
UINT32 IMX471_MIPI_RAW_MOSS_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
#if 0
        if (is_project(21609)) {
                imgsensor_info.normal_video.pclk=140000000;
                imgsensor_info.normal_video.framelength=1822;
                imgsensor_info.normal_video.mipi_pixel_rate = 364000000;
                addr_data_pair_normal_video[11]=0x07;
                addr_data_pair_normal_video[13]=0x1E;
                addr_data_pair_normal_video[81]=0x46;
                addr_data_pair_normal_video[85]=0x0C;
                addr_data_pair_normal_video[87]=0x01;
                addr_data_pair_normal_video[89]=0xC7;
                addr_data_pair_normal_video[103]=0x07;
                addr_data_pair_normal_video[105]=0x0C;
        }
#endif
	...
	return ERROR_NONE;
}	/*	imx4711q_MIPI_RAW_MOSS_SensorInit	*/
