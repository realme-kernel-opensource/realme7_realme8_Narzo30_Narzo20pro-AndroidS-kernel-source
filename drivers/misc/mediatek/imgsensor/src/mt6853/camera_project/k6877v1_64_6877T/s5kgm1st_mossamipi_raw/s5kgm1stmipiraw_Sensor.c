...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info_binning =
{
    ...
    .i4SubBlkW  = 4,
    .i4SubBlkH  = 4,
    .i4PosL = {{8, 31},{12, 31},{16, 31},{20, 31},{10, 37},{14, 37},{18, 37},{22, 37},
                {8, 41},{12, 41},{16, 41},{20, 41},{10, 43},{14, 43},{18, 43},{22, 43}},
    .i4PosR = {{8, 33},{12, 33},{16, 33},{20, 33},{10, 35},{14, 35},{18, 35},{22, 35},
                {8, 39},{12, 39},{16, 39},{20, 39},{10, 45},{14, 45},{18, 45},{22, 45}},
    .i4BlockNumX = 124,
    .i4BlockNumY = 90,
    .iMirrorFlip = 0,
				 ...
				 UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
		*(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = -2268000;
		break;
