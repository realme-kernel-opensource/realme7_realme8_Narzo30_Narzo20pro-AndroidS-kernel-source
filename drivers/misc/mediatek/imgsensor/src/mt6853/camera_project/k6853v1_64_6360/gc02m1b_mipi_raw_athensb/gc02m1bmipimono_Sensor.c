...
static imgsensor_info_struct imgsensor_info = {
       .sensor_id = ATHENSB_GC02M1B_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
        ...
        *sensor_id = 0xFFFFFFFF;
        ...
        while (imgsensor_info.i2c_addr_table[i] != 0xff) {
            ...
            if (deviceInfo_register_value == 0x00) {
                Oplusimgsensor_Registdeviceinfo("Cam_r2",
                ...
                LOG_INF("gc02m1b Read sensor id fail, write id: 0x%x, id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
                retry--;
            } while(retry > 0);
            i++;
            retry = 2;
