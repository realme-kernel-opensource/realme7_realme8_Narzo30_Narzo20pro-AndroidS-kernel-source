...
/* maxinming@ODM.Camera.Drv 20200509 for imx471 remosaic */
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = ATHENSC_IMX471_SENSOR_ID,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[9] = {
    ...
    {4656, 3496, 24, 20, 4608, 3456, 2304, 1728,  0,  0, 2304, 1728, 0, 0, 2304, 1728}, /*normal-video*/
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    ...
    do {
        *sensor_id = return_sensor_id();
        if (*sensor_id == IMX471_SENSOR_ID_20633) {
            *sensor_id = imgsensor_info.sensor_id;
            LOG_INF("IMX471 get_imgsensor_id success: 0x%x\n", *sensor_id);
            return ERROR_NONE;
        }
    ...
    if (*sensor_id != imgsensor_info.sensor_id) {
        LOG_INF("IMX471 get_imgsensor_id failed: 0x%x\n", *sensor_id);
                             ...
                             UINT8 *feature_para,UINT32 *feature_para_len)
{
    ...
    case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
        *(MINT32 *)(signed long)(*(feature_data + 1)) = -16826666;
        break;
