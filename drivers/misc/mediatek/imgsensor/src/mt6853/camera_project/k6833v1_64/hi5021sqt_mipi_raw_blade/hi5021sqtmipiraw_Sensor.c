...
static struct imgsensor_info_struct imgsensor_info = {
     ...
     .pre = {
         ...
         .linelength =  848,             //record different mode'slinelength
         .framelength = 4858,             //record different mode'sframelength
     ...
     .custom1 = {
         .pclk = 124000000,                //record different mode's pclk
         .linelength =  950,             //record different mode'slinelength
         .framelength = 4858,             //record different mode'sframelength
         .startx = 0,                    //record different mode'sstartx of grabwindow
         .starty = 0,                    //record different mode'sstarty of grabwindow
         .grabwindow_width = 4096,         //record different mode'swidth of grabwindow
      ...
      .custom2 = {
         .pclk = 124000000,                //record different mode's pclk
         .linelength =  998,             //record different mode'slinelength
         .framelength = 4127,             //record different mode'sframelength
         .startx = 0,                    //record different mode'sstartx of grabwindow
         .starty = 0,                    //record different mode'sstarty of grabwindow
...
#if MULTI_WRITE //1920X1080 60fps
...
#if MULTI_WRITE //1280x720 120fps
...
#if MULTI_WRITE //3264x2448 24fps
...
#if MULTI_WRITE //2048x 1536 30fps
