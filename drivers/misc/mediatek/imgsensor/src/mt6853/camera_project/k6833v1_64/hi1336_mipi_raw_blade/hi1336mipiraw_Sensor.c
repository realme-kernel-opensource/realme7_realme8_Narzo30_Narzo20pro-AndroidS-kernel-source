...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[6] = {
    { 4224, 3136,   0,   6, 4224, 3124,	 4224, 3124,  32,  2, 4160, 3120, 0, 0, 4160, 3120},		// previrw (4160 x 3120)//DIFF
...
#if ENABLE_PDAF
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info =//4096*3072
{
    .i4OffsetX = 56,//(4160 x 3120)
    .i4OffsetY = 24,
    .i4PitchX = 32,
    .i4PitchY = 32,
    .i4PairNum =8,
    ...
    .i4Crop = { {24, 0}, {24, 0}, {0, 0}, {0, 0}, {0, 0}, {24, 0}, {0, 0}, {0, 0}, {0, 0}, {0, 0} },//4208*3120
    .i4BlockNumX = 128,
    .i4BlockNumY = 96,
...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info_4160_2340 =
{
    ...
    .i4SubBlkW =16,
    .i4SubBlkH =8,
    .i4PosL = {{34,9},{34,25},{50,9},{50,25},{42,13},{42,29},{58,13},{58,29}},
    .i4PosR = {{34,5},{50,5},{42,17},{58,17},{34,21},{50,21},{42,33},{58,33}},
    .i4BlockNumX = 128,
    .i4BlockNumY = 73,
    /* 0:IMAGE_NORMAL,1:IMAGE_H_MIRROR,2:IMAGE_V_MIRROR,3:IMAGE_HV_MIRROR */
    .iMirrorFlip = 0,
...
write_cmos_sensor(0x0668, 0x4303);
	...
	write_cmos_sensor(0x0d02, 0x8004);
	write_cmos_sensor(0x120a, 0x0a00);
...
write_cmos_sensor(0x1060, 0x0008);
...
static void preview_setting(void)
{
	...
	LOG_INF("preview_setting normal write\n");
		...
		write_cmos_sensor(0x3250, 0xa060);
		write_cmos_sensor(0x0730, 0x640f);
		...
		write_cmos_sensor(0x1010, 0x26a0);
		write_cmos_sensor(0x1012, 0x0024);
		write_cmos_sensor(0x1014, 0x0072);
		write_cmos_sensor(0x1016, 0x0072);
		write_cmos_sensor(0x101a, 0x0072);
		...
		write_cmos_sensor(0x020a, 0x1A00);
		write_cmos_sensor(0x021c, 0x0008);
		write_cmos_sensor(0x0206, 0x05dd);
		write_cmos_sensor(0x020e, 0x1A04);
		write_cmos_sensor(0x0b12, 0x1040);
...
write_cmos_sensor(0x0238, 0x1111);
write_cmos_sensor(0x0246, 0x0020);
write_cmos_sensor(0x020a, 0x0cfe);
write_cmos_sensor(0x021c, 0x0008);
write_cmos_sensor(0x0206, 0x05dd);
write_cmos_sensor(0x020e, 0x0d02);
write_cmos_sensor(0x0b12, 0x1040);
write_cmos_sensor(0x0b14, 0x0c30);
write_cmos_sensor(0x0204, 0x0000);
write_cmos_sensor(0x041c, 0x0048);
...
write_cmos_sensor(0x3250, 0xa060); 
write_cmos_sensor(0x0730, 0x7A0f); 
write_cmos_sensor(0x0732, 0xe0b0); 
write_cmos_sensor(0x1118, 0x018c); 
...
write_cmos_sensor(0x1012, 0x018c); 
write_cmos_sensor(0x1014, 0x0072); 
write_cmos_sensor(0x1016, 0x0072); 
write_cmos_sensor(0x101a, 0x0072); 
write_cmos_sensor(0x0404, 0x0008); 
...
write_cmos_sensor(0x0222, 0x0c80); 
write_cmos_sensor(0x022c, 0x0c89); 
write_cmos_sensor(0x0224, 0x01b4); 
write_cmos_sensor(0x022e, 0x0adb); 
write_cmos_sensor(0x0f04, 0x0020); 
write_cmos_sensor(0x0f06, 0x0000); 
write_cmos_sensor(0x023a, 0x1111); 
write_cmos_sensor(0x0234, 0x1111); 
...
write_cmos_sensor(0x020e, 0x0d02); 
write_cmos_sensor(0x0b12, 0x1040); 
write_cmos_sensor(0x0b14, 0x0924); 
write_cmos_sensor(0x0204, 0x0000); 
write_cmos_sensor(0x041c, 0x0048); 
write_cmos_sensor(0x041e, 0x1047); 
write_cmos_sensor(0x0b04, 0x037c); 
...
write_cmos_sensor(0x0246, 0x0020);
write_cmos_sensor(0x020a, 0x033c);
write_cmos_sensor(0x021c, 0x0008);
write_cmos_sensor(0x0206, 0x05dd);
write_cmos_sensor(0x020e, 0x0340);
write_cmos_sensor(0x0b12, 0x0500);
write_cmos_sensor(0x0b14, 0x02d0);
write_cmos_sensor(0x0204, 0x0000);
write_cmos_sensor(0x041c, 0x0048);
write_cmos_sensor(0x041e, 0x1047);
...
write_cmos_sensor(0x0732, 0xe1b0);
write_cmos_sensor(0x1118, 0x01aa);
write_cmos_sensor(0x1200, 0x011f);
write_cmos_sensor(0x1204, 0x1c01);
write_cmos_sensor(0x1240, 0x00f0);
write_cmos_sensor(0x0b20, 0x8200);
write_cmos_sensor(0x0f00, 0x0400);
write_cmos_sensor(0x1002, 0xc319);
write_cmos_sensor(0x103e, 0x0100);
write_cmos_sensor(0x1020, 0xc106);
write_cmos_sensor(0x1022, 0x0617);
write_cmos_sensor(0x1024, 0x0306);
write_cmos_sensor(0x1026, 0x0609);
write_cmos_sensor(0x1028, 0x1207);
write_cmos_sensor(0x102a, 0x090a);
write_cmos_sensor(0x102c, 0x1400);
write_cmos_sensor(0x1010, 0x07d0);
write_cmos_sensor(0x1012, 0x00f4);
write_cmos_sensor(0x1014, 0x0038);
write_cmos_sensor(0x1016, 0x0038);
write_cmos_sensor(0x101a, 0x0038);
write_cmos_sensor(0x0404, 0x0008);
write_cmos_sensor(0x0406, 0x1087);
write_cmos_sensor(0x0220, 0x0008);
...
write_cmos_sensor(0x0222, 0x0c80);
write_cmos_sensor(0x022c, 0x0c89);
write_cmos_sensor(0x0224, 0x020c);
write_cmos_sensor(0x022e, 0x0a81);
write_cmos_sensor(0x0f04, 0x0060);
write_cmos_sensor(0x0f06, 0x0000);
write_cmos_sensor(0x023a, 0x2222);
write_cmos_sensor(0x0234, 0x3311);
write_cmos_sensor(0x0238, 0x3311);
write_cmos_sensor(0x0246, 0x0020);
write_cmos_sensor(0x020a, 0x067d);
write_cmos_sensor(0x021c, 0x0008);
write_cmos_sensor(0x0206, 0x05dd);
write_cmos_sensor(0x020e, 0x0681);
write_cmos_sensor(0x0b12, 0x0780);
write_cmos_sensor(0x0b14, 0x0438);
...
write_cmos_sensor(0x0238, 0x1111);
write_cmos_sensor(0x0246, 0x0020);
write_cmos_sensor(0x020a, 0x103e);
write_cmos_sensor(0x021c, 0x0008);
write_cmos_sensor(0x0206, 0x05dd);
write_cmos_sensor(0x020e, 0x1042);
write_cmos_sensor(0x0b12, 0x1040);
write_cmos_sensor(0x0b14, 0x0c30);
write_cmos_sensor(0x0204, 0x0000);
write_cmos_sensor(0x041c, 0x0048);
