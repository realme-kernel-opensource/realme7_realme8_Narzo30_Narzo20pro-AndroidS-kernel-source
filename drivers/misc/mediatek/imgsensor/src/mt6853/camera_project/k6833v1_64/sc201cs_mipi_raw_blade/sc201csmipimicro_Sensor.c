...
static imgsensor_info_struct imgsensor_info = {
   ...
   // .checksum_value = 0x221b1a41,        //checksum value for Camera Auto Test
    ...
    .frame_time_delay_frame = 1,//bug 663265 zhoumin.wt, add, 2021/09/13, modify for dualcam sync
    ...
    .custom1_delay_frame = 2,//bug 663265 zhoumin.wt, add, 2021/09/17, modify framerate of dualcam to be 24fps

    .isp_driving_current = ISP_DRIVING_4MA, //mclk driving current
    .sensor_interface_type = SENSOR_INTERFACE_TYPE_MIPI,//sensor_interface_type
    .mipi_sensor_type = MIPI_OPHY_NCSI2, //0,MIPI_OPHY_NCSI2;  1,MIPI_OPHY_CSI2
    .mipi_settle_delay_mode = MIPI_SETTLEDELAY_AUTO,//0,MIPI_SETTLEDELAY_AUTO; 1,MIPI_SETTLEDELAY_MANNUAL
    .sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_B,    //+bug682590,zhanghengyuan.wt,ADD,2021/8/26,fix depth sc201cs output_dataformat
...
//+bug 663265 zhoumin.wt, add, 2021/09/13, modify for dualcam sync
...
static void sensor_init(void)
{
    ...
    write_cmos_sensor(0x3221,0x00); //mirror and flip = 0x66, mirror only = 0x06, flip only = 0x60, normal mode = 0x00;
                      ...
                      MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    sensor_info->FrameTimeDelayFrame = imgsensor_info.frame_time_delay_frame;//bug 663265 zhoumin.wt, add, 2021/09/13, modify for dualcam sync
