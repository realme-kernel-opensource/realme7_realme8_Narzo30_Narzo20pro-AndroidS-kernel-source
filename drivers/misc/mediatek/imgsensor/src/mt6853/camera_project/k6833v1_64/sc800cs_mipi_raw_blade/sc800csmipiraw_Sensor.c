...
#define SC800CS_SENSOR_GAIN_MAX_VALID_INDEX  6
#define SC800CS_SENSOR_GAIN_MAP_SIZE         6

#define SC800CS_SENSOR_BASE_GAIN           0x400
...
static kal_uint16 gain2reg(const kal_uint16 gain)
{
	...
	if (reg_gain < SC800CS_SENSOR_BASE_GAIN)
		reg_gain = SC800CS_SENSOR_BASE_GAIN;
	else if (reg_gain > SC800CS_SENSOR_MAX_GAIN)
		reg_gain = SC800CS_SENSOR_MAX_GAIN;
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	kal_uint16 SC800CS_AGC_Param[SC800CS_SENSOR_GAIN_MAP_SIZE][2] = {
		{  1024,  0x00 },
		{  2048,  0x01 },
		{  4096,  0x03 },
		{  8192,  0x07 },
	...
	for (gain_index = SC800CS_SENSOR_GAIN_MAX_VALID_INDEX - 1; gain_index >= 0; gain_index--)
		if (reg_gain >= SC800CS_AGC_Param[gain_index][0])
			break;

	write_cmos_sensor8(0x3e09, SC800CS_AGC_Param[gain_index][1]);
	temp_gain = reg_gain * SC800CS_SENSOR_BASE_GAIN / SC800CS_AGC_Param[gain_index][0];
	write_cmos_sensor8(0x3e07, (temp_gain >> 3) & 0xff);
	LOG_INF("SC800CS_AGC_Param[gain_index][1] = 0x%x, temp_gain = 0x%x, reg_gain = %d, gain = %d\n",
		SC800CS_AGC_Param[gain_index][1], temp_gain, reg_gain, gain);
...
static void preview_setting(void)
{
	...
	write_cmos_sensor8(0x3394,0x10);
	write_cmos_sensor8(0x3395,0x34);
	...
	write_cmos_sensor8(0x3635,0x26);
	...
	write_cmos_sensor8(0x3e02,0xe0);
	write_cmos_sensor8(0x4000,0x00);
	write_cmos_sensor8(0x4001,0x06);
	write_cmos_sensor8(0x4002,0x99);
	write_cmos_sensor8(0x4003,0x99);
	write_cmos_sensor8(0x4004,0x99);
	write_cmos_sensor8(0x4005,0x00);
	write_cmos_sensor8(0x4006,0x0d);
	write_cmos_sensor8(0x4007,0x07);
	write_cmos_sensor8(0x4008,0x00);
	write_cmos_sensor8(0x4009,0xa6);
	write_cmos_sensor8(0x440e,0x02);
	write_cmos_sensor8(0x4509,0x30);
	write_cmos_sensor8(0x5000,0x0e);
	write_cmos_sensor8(0x5799,0x06);
	write_cmos_sensor8(0x59e0,0xfe);
	write_cmos_sensor8(0x59e1,0x40);
	write_cmos_sensor8(0x59e2,0x38);
	write_cmos_sensor8(0x59e3,0x30);
	write_cmos_sensor8(0x59e4,0x20);
	write_cmos_sensor8(0x59e5,0x38);
	write_cmos_sensor8(0x59e6,0x30);
	write_cmos_sensor8(0x59e7,0x20);
	write_cmos_sensor8(0x59e8,0x3f);
	write_cmos_sensor8(0x59e9,0x38);
	write_cmos_sensor8(0x59ea,0x30);
	write_cmos_sensor8(0x59eb,0x3f);
	write_cmos_sensor8(0x59ec,0x38);
	write_cmos_sensor8(0x59ed,0x30);
	write_cmos_sensor8(0x59ee,0xfe);
	write_cmos_sensor8(0x59ef,0x40);
	write_cmos_sensor8(0x59f4,0x38);
	write_cmos_sensor8(0x59f5,0x30);
	write_cmos_sensor8(0x59f6,0x20);
	write_cmos_sensor8(0x59f7,0x38);
	write_cmos_sensor8(0x59f8,0x30);
	write_cmos_sensor8(0x59f9,0x20);
	write_cmos_sensor8(0x59fa,0x3f);
	write_cmos_sensor8(0x59fb,0x38);
	write_cmos_sensor8(0x59fc,0x30);
	write_cmos_sensor8(0x59fd,0x3f);
	write_cmos_sensor8(0x59fe,0x38);
	write_cmos_sensor8(0x59ff,0x30);
...
static void hs_video_setting(void)
{
	...
	write_cmos_sensor8(0x36e9,0x80);
	write_cmos_sensor8(0x36f9,0x80);
	write_cmos_sensor8(0x36eb,0x1c);
	write_cmos_sensor8(0x36ec,0x0b);
	write_cmos_sensor8(0x36ed,0x14);
	write_cmos_sensor8(0x36fc,0x30);
	write_cmos_sensor8(0x36e9,0x00);
	write_cmos_sensor8(0x36f9,0x24);
	write_cmos_sensor8(0x301f,0x19);
	write_cmos_sensor8(0x302d,0x20);
	write_cmos_sensor8(0x3106,0x01);
	...
	write_cmos_sensor8(0x320c,0x06);
	write_cmos_sensor8(0x320d,0xe0);
	write_cmos_sensor8(0x320e,0x04);
	write_cmos_sensor8(0x320f,0xe2);
	...
	write_cmos_sensor8(0x3391,0x03);
	write_cmos_sensor8(0x3392,0x07);
	write_cmos_sensor8(0x3393,0x06);
	write_cmos_sensor8(0x3394,0x0c);
	write_cmos_sensor8(0x3395,0x34);
	write_cmos_sensor8(0x33b1,0x80);
	write_cmos_sensor8(0x341e,0x00);
	write_cmos_sensor8(0x34a9,0x18);
	...
	write_cmos_sensor8(0x3e01,0x9b);
	write_cmos_sensor8(0x3e02,0xa0);
	write_cmos_sensor8(0x4000,0x00);
	write_cmos_sensor8(0x4001,0x02);
	write_cmos_sensor8(0x4002,0x33);
	write_cmos_sensor8(0x4003,0x33);
	write_cmos_sensor8(0x4004,0x33);
	write_cmos_sensor8(0x4005,0x00);
	write_cmos_sensor8(0x4006,0x02);
	write_cmos_sensor8(0x4007,0xe2);
	write_cmos_sensor8(0x4008,0x00);
	write_cmos_sensor8(0x4009,0xfa);
	write_cmos_sensor8(0x440e,0x02);
	write_cmos_sensor8(0x4509,0x30);
	write_cmos_sensor8(0x4837,0x30);
...
static void slim_video_setting(void)
{
	...
	write_cmos_sensor8(0x36eb,0x0c);
	write_cmos_sensor8(0x36ec,0x0b);
	write_cmos_sensor8(0x36ed,0x04);
	write_cmos_sensor8(0x36fa,0x1d);
	write_cmos_sensor8(0x36fb,0x71);
	write_cmos_sensor8(0x36fc,0x10);
	write_cmos_sensor8(0x36fd,0x04);
	write_cmos_sensor8(0x36e9,0x01);
	write_cmos_sensor8(0x36f9,0x23);
	write_cmos_sensor8(0x301f,0x1c);
	write_cmos_sensor8(0x302d,0x20);
	write_cmos_sensor8(0x3106,0x01);
	write_cmos_sensor8(0x3200,0x01);
	write_cmos_sensor8(0x3201,0x60);
	write_cmos_sensor8(0x3202,0x01);
	write_cmos_sensor8(0x3203,0xf8);
	write_cmos_sensor8(0x3204,0x0b);
	write_cmos_sensor8(0x3205,0x6f);
	...
	write_cmos_sensor8(0x320d,0xaa);
	write_cmos_sensor8(0x320e,0x02);
	write_cmos_sensor8(0x320f,0xee);
	...
	write_cmos_sensor8(0x335d,0x60);
	write_cmos_sensor8(0x3364,0x56);
	write_cmos_sensor8(0x3390,0x03);
	write_cmos_sensor8(0x3391,0x07);
	write_cmos_sensor8(0x3392,0x0f);
	write_cmos_sensor8(0x3393,0x0c);
	write_cmos_sensor8(0x3394,0x10);
	...
	write_cmos_sensor8(0x3954,0x86);
	write_cmos_sensor8(0x3e00,0x00);
	write_cmos_sensor8(0x3e01,0x5d);
	write_cmos_sensor8(0x3e02,0x20);
	write_cmos_sensor8(0x4000,0x00);
	write_cmos_sensor8(0x4001,0x04);
	write_cmos_sensor8(0x4002,0x59);
	write_cmos_sensor8(0x4003,0x99);
	write_cmos_sensor8(0x4004,0x99);
	write_cmos_sensor8(0x4005,0x00);
	write_cmos_sensor8(0x4006,0x05);
	write_cmos_sensor8(0x4007,0xb3);
	write_cmos_sensor8(0x4008,0x00);
	write_cmos_sensor8(0x4009,0xfa);
	write_cmos_sensor8(0x440e,0x02);
	write_cmos_sensor8(0x4509,0x30);
	write_cmos_sensor8(0x4800,0x24);
	write_cmos_sensor8(0x4816,0x21);
	write_cmos_sensor8(0x4837,0x10);
	write_cmos_sensor8(0x5000,0x4e);
	write_cmos_sensor8(0x5799,0x06);
	write_cmos_sensor8(0x5900,0xf1);
	write_cmos_sensor8(0x5901,0x04);
