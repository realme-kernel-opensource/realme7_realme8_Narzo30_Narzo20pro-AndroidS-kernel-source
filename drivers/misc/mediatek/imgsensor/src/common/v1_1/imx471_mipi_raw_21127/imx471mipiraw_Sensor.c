...
static struct imgsensor_info_struct imgsensor_info = {
    ...
    .sensor_id = IMX471_SENSOR_ID_21127,

    .checksum_value = 0xb1893b4f, /*checksum value for Camera Auto Test*/
    .pre = { /* reg_G-3 60fps -> sensor mode0 pre*/
        .pclk = 288000000,
        .linelength = 2560,
        .framelength = 1874,
        .startx = 0,
    ...
    .cap = { /* reg_G-3 60fps -> sensor mode1 cap*/
        .pclk = 288000000,
        .linelength = 2560,
        .framelength = 1874,
        .startx = 0,
    ...
    .normal_video = {  /* reg_B-14-1 30fps -> sensor mode2 for video*/
        .pclk = 176000000,
        .linelength = 2560,
        .framelength = 2290,
        .startx = 0,
    ...
    .hs_video = {  /* reg_B-18 120fps -> sensor mode3 for 120fps*/
        .pclk = 580000000,
        .linelength = 2560,
        .framelength = 1888,
        .startx = 0,
    ...
    .slim_video = { /* reg_G-4 60fps -> sensor mode4 for 60fps*/
        .pclk = 216000000,
        .linelength = 2560,
        .framelength = 1406,
        .startx = 0,
        ...
        .mipi_data_lp2hs_settle_dc = 85,
        .max_framerate = 600,
        .mipi_pixel_rate = 274400000,
    },

    .custom1 = { /* reg_B-10-1 30fps sensor mode5 for smile.gifmaker apk*/
        .pclk = 288000000,
        .linelength = 5120,
        .framelength = 3878,
        .startx = 0,
    ...
    .custom2 = { /* reg_B-11-1 1152*864@30fps sensor mode6*/
        .pclk = 138000000,
        .linelength = 2560,
        .framelength = 1796,
        .startx = 0,
        ...
        .grabwindow_height = 1728,
        .mipi_data_lp2hs_settle_dc = 85,
        .mipi_pixel_rate = 307840000,
        .max_framerate = 300,
    },

    .custom3 = { /* reg_A-8 15fps sensor mode7 for remosaic*/
        .pclk = 272000000,
        .linelength = 5120,
        .framelength = 3540,
        .startx = 0,
    ...
    .custom4 = { /* reg_M-1 30fps sensor mode8*/
        .pclk = 132000000,
        .linelength = 2560,
        .framelength = 1718,
        .startx = 0,
    ...
    .custom5 = { /* reg_B-2 30fps sensor mode9 for tencent.mm apk*/
        .pclk = 138000000,
        .linelength = 2560,
        .framelength = 1796,
        .startx = 0,
    ...
    .custom6 = { /* reg_G-1 60fps sensor mode10*/
        .pclk = 216000000,
        .linelength = 2560,
        .framelength = 1406,
        .startx = 0,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[11] = {
	...
	{4656, 3496, 24,  444, 4608, 2608, 2304, 1304,   0,   4, 2304, 1296, 0, 0, 2304, 1296},  /* hsvideo*/
	...
	{4656, 3496, 24,  20,  4608, 3456, 2304, 1728,   0,   0, 2304, 1728, 0, 0, 2304, 1728},  /* custom5 */
	{4656, 3496, 24,  444, 4608, 2608, 2304, 1304,   0,   4, 2304, 1296, 0, 0, 2304, 1296},  /* custom6*/
};

#define FOUR_CELL_SIZE 560
#define EEPROM_SLAVE_ADDRESS (0xA8)
...
static void read_qsc_from_eeprom(void)
{
	...
	for (i = 2; i < (FOUR_CELL_SIZE + 2); i++) {
		...
		iReadRegI2C(pu_send_cmd, 2, &imx471_data_xtalk[i], 1, EEPROM_SLAVE_ADDRESS);
		addr++;
	}
}
...
//    struct CAMERA_DEVICE_INFO * gImgEepromInfo = &gImgEepromInfo_21127;
    ...
    gImgEepromInfo.camNormdata[IMGSENSOR_SENSOR_IDX_SUB][0] = Eeprom_1ByteDataRead(0x00, EEPROM_SLAVE_ADDRESS);
    gImgEepromInfo.camNormdata[IMGSENSOR_SENSOR_IDX_SUB][1] = Eeprom_1ByteDataRead(0x01, EEPROM_SLAVE_ADDRESS);
    ...
    for(i = 2; i < 8; i++) {
        gImgEepromInfo.camNormdata[IMGSENSOR_SENSOR_IDX_SUB][i] = Eeprom_1ByteDataRead(0x04+i, EEPROM_SLAVE_ADDRESS);
    }
    for (i = 0; i < OPLUS_CAMERASN_LENS; i ++) {
        gImgEepromInfo.camNormdata[IMGSENSOR_SENSOR_IDX_SUB][8+i] = Eeprom_1ByteDataRead(0xB0+i, EEPROM_SLAVE_ADDRESS);
    }
...
/* Begin by huangjiwu@Camera.Driver for dufu modify for llhdr monkey at 2021/08/11 */
...
/* End   by huangjiwu@Camera.Driver for dufu modify for llhdr monkey at 2021/08/11 */
    ...
    case SENSOR_FEATURE_GET_FRAME_CTRL_INFO_BY_SCENARIO:
        ...
        *(feature_data + 2) = imgsensor_info.margin;
		...
		case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
			*(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = -3790000;
			break;
#endif
	default:
		break;
