...
#include "gc02m1shine_mipi_Sensor.h"
/************************** Modify Following Strings for Debug **************************/
#define PFX "gc02m1shine_camera_sensor"
#define LOG_1 LOG_INF("GC02M1SHINE, MIPI 1LANE\n")
/****************************   Modify end    *******************************************/
...
static kal_uint16 gc02m1shine_table_write_cmos_sensor(kal_uint16 *para, kal_uint32 len)
{
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	LOG_INF("GC02M1SHINE_AGC_Param[gain_index][1] = 0x%x, temp_gain = 0x%x, reg_gain = %d\n",
...
kal_uint16 addr_data_pair_sw_init_gc02m1shine[] = {
...
kal_uint16 addr_data_pair_sw_preview_gc02m1shine[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_sw_capture_gc02m1shine[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_sw_normal_video_gc02m1shine[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_sw_hs_video_gc02m1shine[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_sw_slim_video_gc02m1shine[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};
...
static void sensor_init(void)
{
	...
	gc02m1shine_table_write_cmos_sensor(
		addr_data_pair_sw_init_gc02m1shine,
		sizeof(addr_data_pair_sw_init_gc02m1shine) /
		sizeof(kal_uint16));
}
...
static void preview_setting(void)
{
	LOG_INF("E\n");
	gc02m1shine_table_write_cmos_sensor(
		addr_data_pair_sw_preview_gc02m1shine,
		sizeof(addr_data_pair_sw_preview_gc02m1shine) /
		sizeof(kal_uint16));
}
...
static void capture_setting(void)
{
	LOG_INF("E\n");
	gc02m1shine_table_write_cmos_sensor(
		addr_data_pair_sw_capture_gc02m1shine,
		sizeof(addr_data_pair_sw_capture_gc02m1shine) /
		sizeof(kal_uint16));
}
...
static void normal_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1shine_table_write_cmos_sensor(
		addr_data_pair_sw_normal_video_gc02m1shine,
		sizeof(addr_data_pair_sw_normal_video_gc02m1shine) /
		sizeof(kal_uint16));
}
...
static void hs_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1shine_table_write_cmos_sensor(
		addr_data_pair_sw_hs_video_gc02m1shine,
		sizeof(addr_data_pair_sw_hs_video_gc02m1shine) /
		sizeof(kal_uint16));
}
...
static void slim_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1shine_table_write_cmos_sensor(
		addr_data_pair_sw_slim_video_gc02m1shine,
		sizeof(addr_data_pair_sw_slim_video_gc02m1shine) /
		sizeof(kal_uint16));
}
...
/*Pengfei.Zhao@Camera.DRV add for register device info 20210907*/
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == GC02M1_SENSOR_ID) {
				...
				if(imgsensor_info.module_id == MODULE_ID_SHINE) {
					*sensor_id = imgsensor_info.sensor_id;
					#ifdef OPLUS_FEATURE_CAMERA_COMMON
					imgsensor_info.module_id = read_module_id();
					if (deviceInfo_register_value == 0x00) {
						register_imgsensor_deviceinfo("Cam_r1", DEVICE_VERSION_GC02M1SHINE, imgsensor_info.module_id);
					...
					*sensor_id = 0xFFFFFFFF;
					printk("gc02m1shine check borard fail\n");
				}
			}
			printk("gc02m1shine Read sensor id fail, write id: 0x%x, id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
			retry--;
		} while (retry > 0);
		i++;
		retry = 2;
	}
	if ((*sensor_id != imgsensor_info.sensor_id) || (imgsensor_info.module_id != MODULE_ID_SHINE)) {
