...
#define ODM_HQ_EDIT
#endif
/* sunhaiyuan@Cam.Drv add open read camera eeprom sn start 20210520  start*/
#include "imgsensor_eeprom.h"
#include "imgsensor_common.h"
#define EEPROM_ADDR 0xA0
static kal_uint8 EepData[DUALCAM_CALI_DATA_LENGTH
			+CAMERA_MODULE_SN_LENGTH+CAMERA_MODULE_INFO_LENGTH];
/* sunhaiyuan@Cam.Drv add open read camera eeprom sn start 20210520  end*/
...
UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_BASE_GAIN_ISO_AND_STEP:
		...
		*(feature_data + 2) = imgsensor_info.gain_type;
		break;
  /* sunhaiyuan@Cam.Drv add open read camera eeprom sn start 20210520 */
