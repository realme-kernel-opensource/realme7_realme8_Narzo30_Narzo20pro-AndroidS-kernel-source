...
#include "gc02m1hlt_mipi_Sensor.h"
/************************** Modify Following Strings for Debug **************************/
#define PFX "gc02m1hlt_camera_sensor"
#define LOG_1 LOG_INF("GC02M1HLT, MIPI 1LANE\n")
/****************************   Modify end    *******************************************/
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	LOG_INF("GC02M1HLT_AGC_Param[gain_index][1] = 0x%x, temp_gain = 0x%x, reg_gain = %d\n",
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	if ((*sensor_id != imgsensor_info.sensor_id) || (imgsensor_info.module_id != MODULE_ID_HLT)) {
