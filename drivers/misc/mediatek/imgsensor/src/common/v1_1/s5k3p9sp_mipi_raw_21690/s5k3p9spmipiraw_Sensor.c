...
static struct imgsensor_info_struct imgsensor_info = {
		...
		.sensor_id = S5K3P9SP_SENSOR_ID_21690,
		#ifdef OPLUS_FEATURE_CAMERA_COMMON
		/*Caohua.Lin@Camera.Driver add for 18011/18311  board 20180723*/
		...
		.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_4CELL_BAYER_Gb,//3p9sp remosaic awb  by wuxiao 20180822
		.mclk = 24,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[8] =
{
	...
	{ 4640,  3488,    0,	0, 4640, 3488, 4640,  3488, 0000, 0000, 4640,  3488,      0,	0, 4640, 3488}, // custom1 remosic
	{ 4640,  3488,    0,	0, 4640, 3488, 4640,  3488, 0000, 0000, 4640,  3488,      0,	0, 4640, 3488}, // custom2 remosic
	{ 4640,  3488,    0,	0, 4640, 3488, 4640,  3488, 0000, 0000, 4640,  3488,      0,	0, 4640, 3488}, // custom3 remosic
}; /*cpy from preview*/
...
static kal_uint16 addr_data_pair_slim_video[] = {
	...
	/*
	S5K3P9SPSXSQ_EVT0_ReferenceSetfile_v1.00***SP_Mode
	Summary	Tetra_binning_1920x1080_30.01fps
	ExtClk :	24	MHz
	Vt_pix_clk :	555.4285714	MHz
	MIPI_output_speed :	696	Mbps/lane
	Crop_Width :	3856	px
	Crop_Height :	2160	px
							 ...
							 UINT8 *feature_para,UINT32 *feature_para_len)
{
	...
	MSDK_SENSOR_REG_INFO_STRUCT *sensor_reg_data= (MSDK_SENSOR_REG_INFO_STRUCT *) feature_para;
        ...
        LOG_INF("fengbin SENSOR_FEATURE_GET_4CELL_DATA feature_id = %d\n", SENSOR_FEATURE_GET_4CELL_DATA);
