...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.sensor_id = OV8856_SENSOR_ID2_20730,
...
static void read_module_data(void)
{
    ...
    for (i = 0; i < CALI_DATA_SLAVE_LENGTH_20730; i ++) {
        gImgEepromInfo.stereoMWdata[CALI_DATA_MASTER_LENGTH_20730+i] =
                    Eeprom_1ByteDataRead(OV8856_STEREO_START_ADDR_20730+i, 0xA2);
    }
