...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV32A1Q_SENSOR_ID_20645,
	...
	.slim_video = { //3264x1840_60fps_4lane1968Mbps
		.pclk = 90000000,
		.linelength =  630,
		.framelength = 2380,
		.startx = 0,
...
//capture
	{ 6528, 4896, 0,  0, 6528, 4896, 3264, 2448,  0,  0, 3264, 2448, 0, 0, 3264, 2448},
//normal-video
	{ 6528, 4896, 0,608, 6528, 3680, 3264, 1840,  0,  0, 3264, 1840, 0, 0, 3264, 1840},
//hs-video
	{ 6528, 4896, 0,  0, 6400, 3600, 1280,  720,  0,  0, 1280,  720, 0, 0, 1280,  720},
//slim-video
	{ 6528, 4896, 0,608, 6528, 3680, 3264, 1840,  0,  0, 3264, 1840, 0, 0, 3264, 1840},
//custom1
	{ 6528, 4896, 0,  0, 6528, 4896, 3264, 2448,288,468, 2688, 1512, 0, 0, 2688, 1512},
//custom2
	{ 6528, 4896, 0,  0, 6528, 4896, 1632, 1224,  0,  0, 1632, 1224, 0, 0, 1632, 1224},
//custom3
...
{
	kal_uint16 idx = 0, addr_xtalk = 0x134E, sensor_addr = 0x53C0;

	for (idx = 0; idx <288; idx++) {
		addr_xtalk = 0x134E + idx;
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_ov32a1q_20645[] = {
	0x0103, 0x01,
	0x0102, 0x01,
	0x0302, 0x31,
	0x0323, 0x05,
...
static void sensor_init(void) //check out
{
	...
	ov32a1q_table_write_cmos_sensor(
		addr_data_pair_init_ov32a1q_20645,
		sizeof(addr_data_pair_init_ov32a1q_20645) /
		sizeof(kal_uint16));
#endif
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_ov32a1q_20645[] = {
	0x0303, 0x00,
	0x0305, 0x64,
	0x0344, 0x01,
	0x0345, 0xe0,
...
#if MULTI_WRITE
	ov32a1q_table_write_cmos_sensor(
		addr_data_pair_preview_ov32a1q_20645,
		sizeof(addr_data_pair_preview_ov32a1q_20645) /
		sizeof(kal_uint16));
...
#if 0
kal_uint16 addr_data_pair_capture_ov32a1q_20645[] = {
	0x0303, 0x00,
	0x0305, 0x3f,
	0x0344, 0x01,
	0x0345, 0xce,
...
static void capture_setting(kal_uint16 currefps)//jack yan check
{
	...
	ov32a1q_table_write_cmos_sensor(
		addr_data_pair_capture_ov32a1q_20645,
		sizeof(addr_data_pair_capture_ov32a1q_20645) /
		sizeof(kal_uint16));
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_normal_video_ov32a1q_20645[] = {
	0x0305, 0x64,
	0x0344, 0x01,
	0x0345, 0xe0,
	0x034a, 0x06,
...
#if MULTI_WRITE
	ov32a1q_table_write_cmos_sensor(
		addr_data_pair_normal_video_ov32a1q_20645,
		sizeof(addr_data_pair_normal_video_ov32a1q_20645) /
		sizeof(kal_uint16));
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_ov32a1q_20645[] = {
	0x0303, 0x00,
	0x0305, 0x3f,
	0x0344, 0x02,
	0x0345, 0x00,
...
#if MULTI_WRITE
	ov32a1q_table_write_cmos_sensor(
		addr_data_pair_hs_video_ov32a1q_20645,
		sizeof(addr_data_pair_hs_video_ov32a1q_20645) /
		sizeof(kal_uint16));
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_ov32a1q_20645[] = {
	0x0303, 0x00,
	0x0305, 0x64,
	0x0344, 0x01,
	0x0345, 0xe0,
...
#if MULTI_WRITE
	ov32a1q_table_write_cmos_sensor(
		addr_data_pair_slim_video_ov32a1q_20645,
		sizeof(addr_data_pair_slim_video_ov32a1q_20645) /
		sizeof(kal_uint16));
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_custom1_ov32a1q_20645[] = {
	0x0303, 0x00,
	0x0305, 0x64,
	0x0344, 0x01,
	0x0345, 0xe0,
...
#if MULTI_WRITE
	ov32a1q_table_write_cmos_sensor(
		addr_data_pair_custom1_ov32a1q_20645,
		sizeof(addr_data_pair_custom1_ov32a1q_20645) /
		sizeof(kal_uint16));
...
kal_uint16 addr_data_pair_custom2_ov32a1q_20645[] = {
	0x0303, 0x00,
	0x0305, 0x64,
	0x0344, 0x01,
	0x0345, 0xe0,
...
#if MULTI_WRITE
	ov32a1q_table_write_cmos_sensor(
		addr_data_pair_custom2_ov32a1q_20645,
		sizeof(addr_data_pair_custom2_ov32a1q_20645) /
		sizeof(kal_uint16));
...
kal_uint16 addr_data_pair_custom3_ov32a1q_20645[] = {
	0x0303, 0x00,
	0x0305, 0x38,
	0x0305, 0x3f,
	0x0344, 0x01,
...
#if MULTI_WRITE
	ov32a1q_table_write_cmos_sensor(
		addr_data_pair_custom3_ov32a1q_20645,
		sizeof(addr_data_pair_custom3_ov32a1q_20645) /
		sizeof(kal_uint16));
...
kal_uint16 addr_data_pair_custom4_ov32a1q_20645[] = {
	0x0303, 0x00,
	0x0305, 0x64,
	0x0344, 0x01,
	0x0345, 0xe0,
...
{
	LOG_INF("%s CUSTOM4_RES_1336*1224_15fps\n", __func__);
#if MULTI_WRITE
	ov32a1q_table_write_cmos_sensor(
		addr_data_pair_custom4_ov32a1q_20645,
		sizeof(addr_data_pair_custom4_ov32a1q_20645) /
		sizeof(kal_uint16));
