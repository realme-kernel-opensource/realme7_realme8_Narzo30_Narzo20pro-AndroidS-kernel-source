...
#include "gc02m1bsy_mipi_Sensor.h"
/************************** Modify Following Strings for Debug **************************/
#define PFX "gc02m1bsy_camera_sensor"
#define LOG_1 LOG_INF("GC02M1BSY, MIPI 1LANE\n")
/****************************   Modify end    *******************************************/
...
#define DEVICE_VERSION_GC02M1BSY    "gc02m1bsy"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC02M1BSY_SENSOR_ID_21690,
...
static kal_uint16 gc02m1bsy_table_write_cmos_sensor(kal_uint16 *para, kal_uint32 len)
{
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	LOG_INF("GC02M1BSY_AGC_Param[gain_index][1] = 0x%x, temp_gain = 0x%x, reg_gain = %d\n",
...
kal_uint16 addr_data_pair_sw_init_gc02m1bsy[] = {
...
kal_uint16 addr_data_pair_sw_preview_gc02m1bsy[] = {
	0x41, 0x04,
	0x42, 0xf4,//30fps
};

kal_uint16 addr_data_pair_sw_capture_gc02m1bsy[] = {
	0x41, 0x04,
	0x42, 0xf4,//30fps
};

kal_uint16 addr_data_pair_sw_normal_video_gc02m1bsy[] = {
	0x41, 0x04,
	0x42, 0xf4,//30fps
};

kal_uint16 addr_data_pair_sw_hs_video_gc02m1bsy[] = {
	0x41, 0x04,
	0x42, 0xf4,//30fps
};

kal_uint16 addr_data_pair_sw_slim_video_gc02m1bsy[] = {
	0x41, 0x04,
	0x42, 0xf4,//30fps
};

kal_uint16 addr_data_pair_custom1_gc02m1bsy[] = {
	0x41, 0x06,
	0x42, 0x38,//24fps
};
static void sensor_init(void)
{
	...
	gc02m1bsy_table_write_cmos_sensor(
		addr_data_pair_sw_init_gc02m1bsy,
		sizeof(addr_data_pair_sw_init_gc02m1bsy) /
		sizeof(kal_uint16));
}
...
static void preview_setting(void)
{
	LOG_INF("E\n");
	gc02m1bsy_table_write_cmos_sensor(
		addr_data_pair_sw_preview_gc02m1bsy,
		sizeof(addr_data_pair_sw_preview_gc02m1bsy) /
		sizeof(kal_uint16));
}
...
static void capture_setting(void)
{
	LOG_INF("E\n");
	gc02m1bsy_table_write_cmos_sensor(
		addr_data_pair_sw_capture_gc02m1bsy,
		sizeof(addr_data_pair_sw_capture_gc02m1bsy) /
		sizeof(kal_uint16));
}
...
static void normal_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1bsy_table_write_cmos_sensor(
		addr_data_pair_sw_normal_video_gc02m1bsy,
		sizeof(addr_data_pair_sw_normal_video_gc02m1bsy) /
		sizeof(kal_uint16));
}
...
static void hs_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1bsy_table_write_cmos_sensor(
		addr_data_pair_sw_hs_video_gc02m1bsy,
		sizeof(addr_data_pair_sw_hs_video_gc02m1bsy) /
		sizeof(kal_uint16));
}
...
static void slim_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1bsy_table_write_cmos_sensor(
		addr_data_pair_sw_slim_video_gc02m1bsy,
		sizeof(addr_data_pair_sw_slim_video_gc02m1bsy) /
		sizeof(kal_uint16));
}
static void custom1_setting(void)
{
	LOG_INF("E\n");
	gc02m1bsy_table_write_cmos_sensor(
		addr_data_pair_custom1_gc02m1bsy,
		sizeof(addr_data_pair_custom1_gc02m1bsy) /
		sizeof(kal_uint16));
}
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == 0x02E0) {
				*sensor_id = GC02M1BSY_SENSOR_ID_21690;
				/*Pengfei.Zhao@Camera.DRV add for register device info 20210514*/
				imgsensor_info.module_id = 0x01;
				if (deviceInfo_register_value == 0x00) {
					register_imgsensor_deviceinfo("Cam_r3", DEVICE_VERSION_GC02M1BSY, imgsensor_info.module_id);
					deviceInfo_register_value=0x01;
				}

				printk("gc02m1bsy i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
				return ERROR_NONE;
			}
			printk("gc02m1bsy Read sensor id fail, write id: 0x%x, id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
			retry--;
		} while (retry > 0);
		i++;
		retry = 2;
