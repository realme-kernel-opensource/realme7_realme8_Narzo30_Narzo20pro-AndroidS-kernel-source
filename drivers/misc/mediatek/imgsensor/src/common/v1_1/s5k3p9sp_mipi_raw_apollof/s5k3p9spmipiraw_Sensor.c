...
static struct imgsensor_info_struct imgsensor_info = {
		.sensor_id = S5K3P9SP_SENSOR_ID_APOLLOF ,
		#ifdef OPLUS_FEATURE_CAMERA_COMMON
		/*Caohua.Lin@Camera.Driver add for 18011/18311  board 20180723*/
			...
			*sensor_id = ((read_cmos_sensor_16_8(0x0000) << 8) | read_cmos_sensor_16_8(0x0001));
			...
			if (*sensor_id == S5K3P9SP_SENSOR_ID) {
				*sensor_id = imgsensor_info.sensor_id;
				printk("guoxiaowei get_imgsensor_id:0x%x  i2c:0x%x\n", *sensor_id, imgsensor.i2c_write_id);
...
UINT32 S5K3P9SP_MIPI_RAW_APOLLOF_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
