 ...
 * Filename:
 * ---------
 *	 even_shinetech_s5kjn103mipi_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#include "even_shinetech_main_s5kjn103mipiraw_Sensor.h"
...
#define PFX "even_shinetech_s5kjn103_camera_sensor"
#define LOG_1 LOG_INF("even_shinetech_s5kjn103,MIPI 4LANE\n")
/****************************   Modify end	**************************/
#define LOG_INF(format, args...) pr_debug(PFX "[%s] " format, __func__, ##args)
#define LOG_ERR(format, args...) pr_err(PFX "[%s] " format, __func__, ##args)

#ifdef OPLUS_FEATURE_CAMERA_COMMON
#define DEVICE_VERSION_S5KJN103	 "even_shinetech_s5kjn103"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = EVEN_SHINETECH_MAIN_S5KJN103_SENSOR_ID,
...
static void read_even_shinetech_s5kjn103_QRSerialdata(UINT8 *read_even_shinetech_s5kjn103_QRSerialdata,
	UINT32 *feature_para_len)
{
	...
	for(i = 0; i < 17; i++){
		read_even_shinetech_s5kjn103_QRSerialdata[i] = (kal_int8)read_cmos_sensor_shinetech_otp(start_addr + i);
		checksum = checksum + read_even_shinetech_s5kjn103_QRSerialdata[i];
	}
	checksum = checksum % 255;
	if(read_cmos_sensor_shinetech_otp(start_addr+17) == 1 && read_cmos_sensor_shinetech_otp(start_addr+18) == checksum ) {
		*feature_para_len = i;
		LOG_INF("even_shinetech_s5kjn103_sn checksum sucess, feature_para_len；%d", *feature_para_len);
	} else {
		*feature_para_len = 0;
		LOG_INF("even_shinetech_s5kjn103_sn checksum failed");
	}
}
*/
#if 0
...
static void even_shinetech_s5kjn103_set_lsc_reg_setting(
...
static kal_uint16 even_shinetech_s5kjn103_capture_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 even_shinetech_s5kjn103_preview_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 even_shinetech_s5kjn103_normal_video_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 even_shinetech_s5kjn103_hs_video_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 even_shinetech_s5kjn103_slim_video_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 even_shinetech_s5kjn103_custom1_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 even_shinetech_s5kjn103_custom2_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static void preview_setting(void)
{
	...
	table_write_cmos_sensor(even_shinetech_s5kjn103_preview_setting,
		sizeof(even_shinetech_s5kjn103_preview_setting)/sizeof(kal_uint16));
...
static void capture_setting(kal_uint16 currefps)
{
	...
	table_write_cmos_sensor(even_shinetech_s5kjn103_capture_setting,
		sizeof(even_shinetech_s5kjn103_capture_setting)/sizeof(kal_uint16));
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	table_write_cmos_sensor(even_shinetech_s5kjn103_normal_video_setting,
		sizeof(even_shinetech_s5kjn103_normal_video_setting)/sizeof(kal_uint16));
	LOG_INF("X\n");
}
...
static void hs_video_setting(void)
{
	...
	table_write_cmos_sensor(even_shinetech_s5kjn103_hs_video_setting,
		sizeof(even_shinetech_s5kjn103_hs_video_setting)/sizeof(kal_uint16));
	LOG_INF("X\n");
}
...
static void slim_video_setting(void)
{
	...
	table_write_cmos_sensor(even_shinetech_s5kjn103_slim_video_setting,
		sizeof(even_shinetech_s5kjn103_slim_video_setting)/sizeof(kal_uint16));
	LOG_INF("X\n");
}
...
static void custom1_setting(void)
{
	...
	/*************MIPI output setting************/
	table_write_cmos_sensor(even_shinetech_s5kjn103_custom1_setting,
		sizeof(even_shinetech_s5kjn103_custom1_setting)/sizeof(kal_uint16));
	LOG_INF("X");
}
...
static void custom2_setting(void)
{
	LOG_INF("%s CUS1_16M_24_FPS E! currefps\n", __func__);
	/*************MIPI output setting************/
	table_write_cmos_sensor(even_shinetech_s5kjn103_custom2_setting,
		sizeof(even_shinetech_s5kjn103_custom2_setting)/sizeof(kal_uint16));
	LOG_INF("X");
}
			...
			if (*sensor_id == 0x38e1) {
			    *sensor_id = imgsensor_info.sensor_id;
				...
				if(deviceInfo_register_value == 0x00){
					register_imgsensor_deviceinfo("Cam_r0", DEVICE_VERSION_S5KJN103,
									imgsensor_info.module_id);
				 ...
				 UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_SET_LSC_TBL:
	{
		...
		even_shinetech_s5kjn103_set_lsc_reg_setting(index, feature_data_16,
					  (*feature_para_len)/sizeof(UINT16));
	}
		break;
	/*case SENSOR_FEATURE_GET_SERIANO_IC:
		read_even_shinetech_s5kjn103_QRSerialdata(feature_data_8, feature_para_len);
