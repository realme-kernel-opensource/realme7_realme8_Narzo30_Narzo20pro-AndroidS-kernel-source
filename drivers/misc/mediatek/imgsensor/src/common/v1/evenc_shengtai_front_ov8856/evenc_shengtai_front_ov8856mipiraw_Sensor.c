 ...
 * Filename:
 * ---------
 *	 EVENC_SHENGTAI_FRONT_OV8856mipiraw_sensor.c
 *
 * Project:
 * --------
 *	 ALPS MT6758
...
#include "evenc_shengtai_front_ov8856mipiraw_Sensor.h"

#define PFX "EVENC_SHENGTAI_FRONT_OV8856"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = EVENC_SHENGTAI_FRONT_OV8856_SENSOR_ID,		/*record sensor id defined in Kd_imgsensor.h*/
...
static kal_uint16 evenc_shengtai_front_ov8856_table_write_cmos_sensor(kal_uint16 *para, kal_uint32 len)
{
...
static kal_uint16 addr_data_pair_init_evenc_shengtai_front_ov8856[] = {
	0x0103, 0x01,
	0x0302, 0x3c,
	0x0303, 0x01,
	0x031e, 0x0c,
...
static void sensor_init(void)
{
	LOG_INF("v3 E\n");
#if 1	/* MULTI_WRITE */
	evenc_shengtai_front_ov8856_table_write_cmos_sensor(addr_data_pair_init_evenc_shengtai_front_ov8856,
			   sizeof(addr_data_pair_init_evenc_shengtai_front_ov8856) / sizeof(kal_uint16));
#endif
...
*
*************************************************************************/
static kal_uint16 addr_data_pair_preview_evenc_shengtai_front_ov8856[] = {
	0x3501, 0x4c,
	0x3502, 0xe0,
	0x366d, 0x00,
	0x366e, 0x08,
...
#endif
	evenc_shengtai_front_ov8856_table_write_cmos_sensor(addr_data_pair_preview_evenc_shengtai_front_ov8856,
				   sizeof(addr_data_pair_preview_evenc_shengtai_front_ov8856) / sizeof(kal_uint16));
...
*
*************************************************************************/
static kal_uint16 addr_data_pair_capture_30fps_evenc_shengtai_front_ov8856[] = {
	0x3501, 0x9a,
	0x3502, 0x20,
	0x366d, 0x00,
	0x366e, 0x10,
...
static kal_uint16 addr_data_pair_capture_15fps_evenc_shengtai_front_ov8856[] = {
	0x3501, 0x9a,
	0x3502, 0x20,
	0x366d, 0x00,
	0x366e, 0x10,
...
#endif
	if (currefps == 150) {
		evenc_shengtai_front_ov8856_table_write_cmos_sensor(addr_data_pair_capture_15fps_evenc_shengtai_front_ov8856,
					       sizeof(addr_data_pair_capture_15fps_evenc_shengtai_front_ov8856) /
					       sizeof(kal_uint16));
	} else {
		evenc_shengtai_front_ov8856_table_write_cmos_sensor(addr_data_pair_capture_30fps_evenc_shengtai_front_ov8856,
					       sizeof(addr_data_pair_capture_30fps_evenc_shengtai_front_ov8856) /
					       sizeof(kal_uint16));
...
static kal_uint16 addr_data_pair_normal_video_evenc_shengtai_front_ov8856[] = {
	0x0300, 0x02,
	0x0302, 0x3d,
	0x0303, 0x00,
	0x3501, 0x9a,
...
{
	evenc_shengtai_front_ov8856_table_write_cmos_sensor(addr_data_pair_normal_video_evenc_shengtai_front_ov8856,
		sizeof(addr_data_pair_normal_video_evenc_shengtai_front_ov8856) /
		sizeof(kal_uint16));
}
...
static kal_uint16 addr_data_pair_vga_setting_120fps_evenc_shengtai_front_ov8856[] = {
	0x3501, 0x25,
	0x3502, 0xc0,
	0x366d, 0x11,
	0x366e, 0x08,
...
//		write_cmos_sensor(0x0100, 0x01);
	...
	evenc_shengtai_front_ov8856_table_write_cmos_sensor(addr_data_pair_vga_setting_120fps_evenc_shengtai_front_ov8856,
				   sizeof(addr_data_pair_vga_setting_120fps_evenc_shengtai_front_ov8856) /
				   sizeof(kal_uint16));
...
*
*************************************************************************/
static kal_uint16 addr_data_pair_custom1_24fps_evenc_shengtai_front_ov8856[] = {
	0x3501, 0x9a,
	0x3502, 0x20,
	0x366d, 0x00,
	0x366e, 0x10,
...
{
    LOG_INF("E! custom1:%d\n", currefps);
    evenc_shengtai_front_ov8856_table_write_cmos_sensor(addr_data_pair_custom1_24fps_evenc_shengtai_front_ov8856,
                       sizeof(addr_data_pair_custom1_24fps_evenc_shengtai_front_ov8856) /
                       sizeof(kal_uint16));
}

static kal_uint16 addr_data_pair_custom2_24fps_evenc_shengtai_front_ov8856[] = {
	0x3501, 0x9a,
	0x3502, 0x20,
	0x366d, 0x00,
	0x366e, 0x10,
...
{
    LOG_INF("E! custom1:%d\n", currefps);
    evenc_shengtai_front_ov8856_table_write_cmos_sensor(addr_data_pair_custom2_24fps_evenc_shengtai_front_ov8856,
                       sizeof(addr_data_pair_custom2_24fps_evenc_shengtai_front_ov8856) /
                       sizeof(kal_uint16));
}
...
static kal_uint32 open(void)
{
	...
	sensor_init();
	mdelay(5);
	#ifdef EVENC_SHENGTAI_FRONT_OV8856R1AOTP
