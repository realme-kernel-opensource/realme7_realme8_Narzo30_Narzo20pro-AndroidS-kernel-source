...
/* Don't edit this region! It is auto-generated by scripts, region_start */
...
#define PROC_MS_INFO		 (PROC_MS_UID | PROC_MS_PID | PROC_MS_PPID | PROC_MS_OOM_SCORE_ADJ | PROC_MS_32BIT | PROC_MS_COMM)
...
#define PROC_MS_ITERATE_FD	 (PROC_MS_NR_FDS | PROC_MS_ASHMEM | PROC_MS_DMABUF)
#define PROC_MS_ITERATE_VMA	 (PROC_MS_PSS | PROC_MS_NATIVEHEAP | PROC_MS_JAVAHEAP)
#define PROC_MS_ITERATE_VMA_NAME (PROC_MS_NATIVEHEAP | PROC_MS_JAVAHEAP)

#define PROC_MS_VALID_FLAGS	 (PROC_MS_COMMON | PROC_MS_ITERATE_FD | PROC_MS_ITERATE_VMA)
