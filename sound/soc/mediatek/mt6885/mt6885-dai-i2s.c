...
static int mt6885_i2s_hd_set(struct snd_kcontrol *kcontrol,
			     struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static const struct snd_kcontrol_new mtk_dai_i2s_controls[] = {
	...
	SOC_ENUM_EXT(MTK_AFE_I2S1_KCONTROL_NAME, mt6885_i2s_enum[0],
		     mt6885_i2s_hd_get, mt6885_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_I2S2_KCONTROL_NAME, mt6885_i2s_enum[0],
		     mt6885_i2s_hd_get, mt6885_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_I2S3_KCONTROL_NAME, mt6885_i2s_enum[0],
		     mt6885_i2s_hd_get, mt6885_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_I2S5_KCONTROL_NAME, mt6885_i2s_enum[0],
		     mt6885_i2s_hd_get, mt6885_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_I2S6_KCONTROL_NAME, mt6885_i2s_enum[0],
		     mt6885_i2s_hd_get, mt6885_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_I2S7_KCONTROL_NAME, mt6885_i2s_enum[0],
		     mt6885_i2s_hd_get, mt6885_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_I2S8_KCONTROL_NAME, mt6885_i2s_enum[0],
		     mt6885_i2s_hd_get, mt6885_i2s_hd_set),
			    ...
			    int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		mt6885_afe_gpio_request(afe, true, i2s_priv->id, 0);
		break;
	case SND_SOC_DAPM_POST_PMD:
		mt6885_afe_gpio_request(afe, false, i2s_priv->id, 0);
		break;
	default:
		break;
	}
			  ...
			  int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		if (strcmp(w->name, APLL1_W_NAME) == 0)
			mt6885_apll1_enable(afe);
		else
			mt6885_apll2_enable(afe);
		break;
	case SND_SOC_DAPM_POST_PMD:
		if (strcmp(w->name, APLL1_W_NAME) == 0)
			mt6885_apll1_disable(afe);
		else
			mt6885_apll2_disable(afe);
		break;
	default:
		break;
	}
			     ...
			     int event)
{
	...
	switch (event) {
	case SND_SOC_DAPM_PRE_PMU:
		mt6885_mck_enable(afe, i2s_priv->mclk_id, i2s_priv->mclk_rate);
		break;
	case SND_SOC_DAPM_POST_PMD:
		i2s_priv->mclk_rate = 0;
		mt6885_mck_disable(afe, i2s_priv->mclk_id);
		break;
	default:
		break;
	}
				    ...
				    struct snd_soc_dapm_widget *sink)
{
	...
	/* which apll */
	cur_apll = mt6885_get_apll_by_name(afe, source->name);

	/* choose APLL from i2s rate */
	i2s_need_apll = mt6885_get_apll_by_rate(afe, i2s_priv->rate);
...
static const struct snd_soc_dapm_route mtk_dai_i2s_routes[] = {
	...
	{"I2S7_Out_Mux", "Output_Widget", "I2S7"},
	{"I2S_DUMMY_OUT", NULL, "I2S7_Out_Mux"},

	{"I2S9_Out_Mux", "Output_Widget", "I2S9"},
					 ...
					 struct snd_soc_dai *dai)
{
	...
	unsigned int rate_reg = mt6885_rate_transform(afe->dev,
						      rate, dai->id);
				  ...
				  int clk_id, unsigned int freq, int dir)
{
	...
	apll = mt6885_get_apll_by_rate(afe, freq);
	apll_rate = mt6885_get_apll_rate(afe, apll);
...
static const struct mtk_afe_i2s_priv mt6885_i2s_priv[DAI_I2S_NUM] = {
	[DAI_I2S0] = {
		.id = MT6885_DAI_I2S_0,
		.mclk_id = MT6885_I2S0_MCK,
		.share_property_name = "i2s0-share",
		.share_i2s_id = -1,
	},
	[DAI_I2S1] = {
		.id = MT6885_DAI_I2S_1,
		.mclk_id = MT6885_I2S1_MCK,
		.share_property_name = "i2s1-share",
		.share_i2s_id = -1,
	},
	[DAI_I2S2] = {
		.id = MT6885_DAI_I2S_2,
		.mclk_id = MT6885_I2S2_MCK,
		.share_property_name = "i2s2-share",
		.share_i2s_id = -1,
	},
	[DAI_I2S3] = {
		.id = MT6885_DAI_I2S_3,
		.mclk_id = MT6885_I2S3_MCK,
		.share_property_name = "i2s3-share",
		.share_i2s_id = -1,
	},
	[DAI_I2S5] = {
		.id = MT6885_DAI_I2S_5,
		.mclk_id = MT6885_I2S5_MCK,
		.share_property_name = "i2s5-share",
		.share_i2s_id = -1,
	},
	[DAI_I2S6] = {
		.id = MT6885_DAI_I2S_6,
		.mclk_id = MT6885_I2S6_MCK,
		.share_property_name = "i2s6-share",
		.share_i2s_id = -1,
	},
	[DAI_I2S7] = {
		.id = MT6885_DAI_I2S_7,
		.mclk_id = MT6885_I2S7_MCK,
		.share_property_name = "i2s7-share",
		.share_i2s_id = -1,
	},
	[DAI_I2S8] = {
		.id = MT6885_DAI_I2S_8,
		.mclk_id = MT6885_I2S8_MCK,
		.share_property_name = "i2s8-share",
		.share_i2s_id = -1,
	},
	[DAI_I2S9] = {
		.id = MT6885_DAI_I2S_9,
		.mclk_id = MT6885_I2S9_MCK,
		.share_property_name = "i2s9-share",
		.share_i2s_id = -1,
	},
};

int mt6885_dai_i2s_get_share(struct mtk_base_afe *afe)
{
	struct mt6885_afe_private *afe_priv = afe->platform_priv;
	...
	for (i = 0; i < DAI_I2S_NUM; i++) {
		i2s_priv = afe_priv->dai_priv[mt6885_i2s_priv[i].id];
		property_name = mt6885_i2s_priv[i].share_property_name;
...
int mt6885_dai_i2s_set_priv(struct mtk_base_afe *afe)
{
	int i;
	int ret;

	for (i = 0; i < DAI_I2S_NUM; i++) {
		ret = mt6885_dai_set_priv(afe, mt6885_i2s_priv[i].id,
...
int mt6885_dai_i2s_register(struct mtk_base_afe *afe)
{
	...
	ret = mt6885_dai_i2s_set_priv(afe);
	if (ret)
		return ret;

	/* parse share i2s */
	ret = mt6885_dai_i2s_get_share(afe);
	if (ret)
		return ret;
